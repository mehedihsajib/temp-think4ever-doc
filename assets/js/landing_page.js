...
(function () {
    ...
    items.forEach(function (item) {
      item.addEventListener("click", function () {
        ...
        if (lang && typeof I18n !== "undefined") {
          ...
          // Fallback if i18n not loaded or not a lang item
  ...
  // Listen for i18n changes to update labels
  document.addEventListener("i18n:applied", function (e) {
    const locale = e.detail.locale;
    const labels = document.querySelectorAll(".lp-dropdown-label");
    labels.forEach((label) => {
      // Find the active item for this locale in the parents menu
      const dropdown = label.closest(".lp-dropdown");
      if (dropdown) {
        const activeItem = dropdown.querySelector(
          `.lp-dropdown-item[data-lang="${locale}"]`,
        );
        if (activeItem) {
          label.textContent = activeItem.textContent.trim();
          // Update active class
          dropdown
            .querySelectorAll(".lp-dropdown-item")
  ...
  const searchIndex = [
    {
      title: "Merchant Wallet - Getting Started",
      desc: "Download, install, and set up your merchant wallet",
      page: "merchant_getting_started",
    },
    {
      title: "Consumer Wallet - Getting Started",
      desc: "Download, install, and set up your consumer wallet",
      page: "consumer_getting_started",
    },
    {
      title: "QR Code Payments",
      desc: "Generate and scan QR codes for instant payments",
      page: "merchant_qr_payments",
    },
    {
      title: "NFC Tap-to-Pay",
      desc: "Set up and use NFC contactless payments",
      page: "merchant_nfc_payments",
    },
    {
      title: "Transaction Management",
      desc: "View, manage, and export your transactions",
      page: "merchant_transactions",
    },
    {
      title: "Account Setup & Verification",
      desc: "Complete your KYC and business profile",
      page: "merchant_account_setup",
    },
    {
      title: "Making Payments",
      desc: "Pay with QR codes and NFC as a consumer",
      page: "consumer_making_payments",
    },
    {
      title: "Wallet Management",
      desc: "Top up, withdraw, and manage your balance",
      page: "consumer_wallet_management",
    },
    {
      title: "P2P Transfers",
      desc: "Send money to friends and family",
      page: "consumer_p2p_transfers",
    },
    {
      title: "Troubleshooting - Merchant",
      desc: "Common issues and solutions for merchants",
      page: "merchant_troubleshooting",
    },
    {
      title: "Troubleshooting - Consumer",
      desc: "Common issues and solutions for consumers",
      page: "consumer_troubleshooting",
    },
    {
      title: "Blog & Updates",
      desc: "Latest news, tips, and announcements",
      page: "blog_listing",
    },
    {
      title: "Changelog & Release Notes",
      desc: "Version history and release notes",
      page: "changelog_page",
    },
    {
      title: "Send Feedback",
    ...
    },
    {
      ...
      desc: "Configure app settings and security preferences",
      page: "consumer_settings",
    },
    {
      title: "Merchant Settings",
      desc: "Configure merchant app settings and notifications",
      page: "merchant_settings",
    },
  ];
  ...
  function renderSearchResults(query) {
    ...
    if (!query.trim()) {
      const emptyMsg =
        typeof I18n !== "undefined"
          ? I18n.t("landing.search.modal_empty")
          : "Start typing to search documentation...";
      searchResultsContainer.innerHTML =
        '<div class="lp-search-empty">' + emptyMsg + "</div>";
      return;
    }
    ...
    if (results.length === 0) {
      const noResultsMsg =
        typeof I18n !== "undefined"
          ? I18n.t("landing.search.modal_no_results", { query: query })
          : 'No results found for "' + query + '"';
      searchResultsContainer.innerHTML =
        '<div class="lp-search-empty">' + noResultsMsg + "</div>";
      return;
    }
    ...
    results.forEach(function (r) {
      html +=
        '<div class="lp-search-result-item" tabindex="0" onclick="closeSearchAndNavigate(\'' +
        r.page +
        '\')" role="button">';
