      ...
      <main>
        ...
        <section>
          ...
          <div>
            ...
            />
            <img alt="Quick Tour " src="/assets/images/dev-doc/take-tour.png" />
          </div>
          <h3>Project Directory &amp; Core Navigation (Left Pane)</h3>
          <p>
            The sidebar keeps your overall structure accessible while navigating
            code logic:
          </p>
          <ul>
            <li>
              Header Controls: * Displays the parent project folder name (e.g.,
              MCB Customer Appointment).
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              <span>
                ...
                jump back to the platform's root administrative options, such as
                Settings or Billing.
              </span>
            </li>
          </ul>
          <h3>Live Agent Log &amp; Execution Monitor (Center Pane)</h3>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              <span>
                ...
                buttons, filter by log severity levels, or adjust rows per page
                options to review long agent runs.
              </span>
            </li>
          </ul>
          <h3>AI Copilot Chat Interface (Right Pane)</h3>
          <p>
            The side chat window provides a direct channel to prompt, guide, and
            instruct your autonomous engineering agents:
          </p>
          <ul>
            <li>
              <strong>Chat Conversation Feed: </strong>
              Displays context-aware conversations detailing recent build tasks,
              file generations, and test results.
            </li>
            <li>
              <strong>System State Indicator:</strong>
              <span>
                Located at the bottom corner, displaying a "Ready for next task"
                status to confirm the background agent has completed its last
                loop and is listening for fresh development inputs.
              </span>
            </li>
            <li>
              <strong>Input Action Bar</strong>
              <span>
                Enter natural language instructions (e.g., "Write a new API
                endpoint for booking confirmation" or "Fix the syntax error in
                the database helper script") to automatically trigger your next
                agent generation cycle.
              </span>
            </li>
          </ul>
          <h3>Switch to Developer Mode</h3>
          <p>
          ...
          <div>
            <img
              alt="Dev Mode"
              src="/assets/images/dev-doc/27-switch-to-dev.png"
            />
          </div>
          <h3>Switch to Design/Architect Mode</h3>
          <p>
            Quick access to Design mode can be found on the upper portion of the
            page when you are currently in Developer Mode. Just tap on Switch to
            Design/Architect Mode button.
          </p>
          <div>
            <img
              alt="Dev Mode"
              src="/assets/images/dev-doc/27-switch-to-design.png"
            />
          </div>
          <p>
            ...
            technical builders, this developer-friendly interface grants direct
            access to the project's repository files, allowing engineers to
            write code, modify logic, and deploy updates seamlessly in real
            time.
          </p>
          <br />
          <p>
            This workspace supports multiple stages of the Software Development
            Life Cycle (SDLC), including development, testing, debugging,
            architecture review, and deployment preparation.
          </p>
          <div>
            <img
              alt="Dev Mode"
              src="/assets/images/dev-doc/27-dev-mode-3.png"
            />
          </div>
          ...
          <div>
            <img
              alt="Dev Mode"
              src="/assets/images/dev-doc/28-nav-buttons.png"
            />
          </div>
          <div className="para-box">
            <h4>Switch to Design/Architect Mode</h4>
            <ul>
          ...
          <div className="para-box">
            ...
            <p>
              This helps align development activities with business and project
              requirements.
            </p>
          </div>
          <div className="para-box">
            ...
            <ul>
              <li>
                ...
                <span>
                  Opens an interactive blueprint map showing how your current
              ...
              <li>
                ...
                <span>
                  Displays a live, centralized log of validation conflicts, sync
                  warnings, or errors that need to be resolved before running
                  background tasks.
                </span>
              </li>
            </ul>
          ...
          <div className="para-box">
            <h4>Tools</h4>
            <p>
              The Tools dropdown menu is a centralized development utility panel
              located in the main workspace header bar. It provides developers
              with instant access to the core interactive components of their
              active project environment.
            </p>
            <p>The dropdown contains three primary operational modules:</p>
            <ul>
              <li>
                <strong>Database:</strong>
                <span>
                  Launches an integrated command-line interface within the
              ...
              <li>
                ...
                <span>
                  Bridges the active project space directly with an embedded or
                  linked Visual Studio Code environment for advanced code
                  editing and engineering modifications.
                </span>
              </li>
            </ul>
          </div>
          <h3>Connect your project to VSC (Visual Studio Code)</h3>
          <div className="image-wrapper pb-0">
            <img
              alt="Dev Mode"
              src="/assets/images/dev-doc/26-dev-mode-4.png"
            />
          </div>
          <div className="para-box">
          ...
          <div className="para-box">
            <h3>Left Sidebar Menu Navigation</h3>
            <p>
              When you switch the Think4Ever platform into
              <strong>Developer Mode</strong>, the primary navigation shifts to
              a streamlined, icon-based left sidebar menu. This specialized menu
              allows technical users to quickly toggle between chat interfaces,
              systemic architecture blueprints, underlying files, and
              integration consoles without losing their active development
              context.
            </p>
            <div>
              <img
                alt="Left Sidebar Menu Navigation"
                src="/assets/images/dev-doc/left-menu-1.png"
              />
            </div>
          </div>
          <div className="para-box">
          ...
          <div className="para-box">
            ...
            <p>
              ...
              interface preferences, manage individual security parameters (such
              as updating multi-factor authentication or passwords), and track
              your usage history or data access logs across the workspace.
            </p>
          </div>
          <div className="para-box">
            ...
            <div>
              <img
                ...
                src="/assets/images/dev-doc/left-menu-2.png"
              />
            </div>
          </div>
          <div className="para-box">
            ...
            <p>
              ...
              the Access Tokens management engine. Use this section to provision
              new alphanumeric bearer credentials, set precise method scopes
              (enforcing distinct read or write validation parameters per
              resource block), monitor expiration timelines, or instantly revoke
              active access tokens if security is compromised.
            </p>
            <div>
              <img
                alt="API Keys"
                src="/assets/images/dev-doc/left-menu-3.png"
              />
            </div>
          </div>
          <div className="para-box">
            ...
            <p>
              ...
              configuring local client .mcp.json parameters), or view deployment
              tracking histories.
            </p>
            <div>
              <img
                alt="Version Control"
                src="/assets/images/dev-doc/left-menu-4.png"
              />
            </div>
          </div>
          <div className="para-box">
            <h4>Design / Architect mode</h4>
            <p>
              Toggles the global operational workspace template into the visual
              ideation and blueprint architecture environment. Select this mode
              to exit low-level code generation panels, file views, and terminal
              log blocks. Switching to Design / Architect mode returns your
              interface to high-level system blueprints, including visual
              drag-and-drop toolboxes for designing UI screen concepts, building
              sequential business flows, mapping relational data objects, and
              declaring global business rules.
            </p>
          </div>
          <div className="para-box">
            <h4>Log out</h4>
            <p>
              ...
              project assets, project configurations, and private credentials on
          ...
          <div className="para-box">
            ...
            <div>
              <img
                ...
                src="/assets/images/dev-doc/left-menu-5.png"
              />
            </div>
          </div>
        </section>
