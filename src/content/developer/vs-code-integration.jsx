...
<img alt="VS Code Integration" className="demo-img" src="/assets/images/dev-doc/vscode-1.png"/>
</div>
<div className="para-box">
<p>To connect your project to <strong>VS Code:</strong></p>
...
<li>
                ...
                <div className="image-wrapper">
<img alt="VS Code Integration" className="demo-img" src="/assets/images/dev-doc/vscode-2.png"/>
</div>
</li>
<li>
...
<li>
                Once installed, click on the extension icon in the sidebar,
                then select <strong>Think4Ever</strong> icon.
              </li>
<li>
                Click the ... <strong>(More Actions)</strong> icon at the top
                of the Extensions pane.
              </li>
<li>
<strong>Click Install</strong> from VSIX
                <div className="image-wrapper">
<img alt="VS Code Integration" className="demo-img" src="/assets/images/dev-doc/vscode-3.png"/>
</div>
</li>
<li>
...
<li>
                ...
                <div className="image-wrapper">
<img alt="VS Code Integration" className="demo-img" src="/assets/images/dev-doc/vscode-4.png"/>
</div>
</li>
</ol>
</div>
...
<div className="para-box">
<h4 className="h4">Optional: Open Terminal in VS Code</h4>
<p>Inside VS Code:</p>
<ul className="cd-overview-ul">
<li>Go to <strong>Terminal &rarr; New Terminal</strong></li>
<li>
                Or press:
                <ul>
<li><strong>Ctrl +</strong> ` (Windows)</li>
<li><strong>Cmd +</strong> ` (Mac)</li>
</ul>
</li>
</ul>
</div>
