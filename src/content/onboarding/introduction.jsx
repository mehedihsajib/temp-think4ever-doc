...
const OnboardingIntroduction = () => {
  return (
    <div className="doc-page-content">
      <div className="step-content" id="step-0">
...
<img alt="" src="/assets/images/customer-onboard/00-homepage.png"/>
</div>
</section>
</div>
<h3 className="h3">Navigation Bar</h3>
<p>
...
<li>Features &ndash; Displays the platform capabilities and tools.</li>
<li>
...
<h4 className="h4">Action Buttons</h4>
<ul className="cd-overview-ul">
<li>Sign In &ndash; Redirects users to the login page.</li>
<li>
              Get Started &ndash; Begins the onboarding or registration process for
              new users.
            </li>
</ul>
<h4 className="h4">How to Use the Home Page</h4>
...
<li>
              Select How It Works to understand the AI-assisted workflow.
            </li>
