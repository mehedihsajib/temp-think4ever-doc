...
<img alt="" src="/assets/images/customer-onboard/07-enter-workspace.png"/>
</div>
</section>
<section className="bento-card">
<div className="card-body">
...
<div className="image-wrapper">
<img alt="" src="/assets/images/customer-onboard/9.1-create-project.png"/>
</div>
</section>
<section className="bento-card">
<div className="card-body">
...
<div style={{display: 'flex', flexDirection: 'column', gap: '30px'}} className="image-wrapper">
...
<div className="image-wrapper">
<img alt="" src="/assets/images/customer-onboard/10-project-mode.png"/>
</div>
</section>
</div>
</div>
