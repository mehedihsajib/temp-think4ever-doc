...
<h1 className="cd-page-title" data-i18n="containers.title">Containers</h1>
...
<p className="cd-overview-p" data-i18n-html="containers.intro">
            ...
            Think4Ever AI ensures that your project &mdash; runs identically on your
            local machine, a staging server, or the cloud.
          </p>
<img alt="Containers Dashboard" className="demo-img" src="/assets/images/containers.png"/>
<p style={{marginTop: '32px', fontWeight: '600', color: '#000'}} className="cd-overview-p" data-i18n-html="containers.fpt_title">
            There are four powerful tabs:
          </p>
<table className="config-table">
<thead>
<tr>
<th data-i18n="containers.t1_h1">Tab</th>
<th data-i18n="containers.t1_h2">What it enables</th>
</tr>
</thead>
<tbody>
<tr>
...
<td data-i18n-html="containers.r4_c2">
                  ...
                  local machine or <strong>Push to Source</strong> to add it
