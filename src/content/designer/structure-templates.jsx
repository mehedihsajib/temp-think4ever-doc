...
<h1 className="cd-page-title" id="cdHomeTitle">Structure Templates</h1>

<section className="cd-overview" id="cdHomeOverview">
<p className="cd-overview-text" data-i18n="dev_intro.description">
            The Structure Templates or also called Solution Designs Library is
            a centralized repository of pre-built solution templates that
            helps users quickly discover and evaluate software solution
            concepts across various industries and business domains.
          </p>
...
<p>
            After selecting a solution design template from the Solution
            Designs Library, the system displays a list of available
            subcategories, including application modules, pages, features, and
            business flows associated with the selected template.
          </p>
<ul className="cd-overview-ul">
<li>
...
<li>
              Select or deselect specific modules based on project
              requirements.
            </li>
...
<img alt="Data Objects Schema Visualizer" className="demo-img" src="/assets/images/templates-2.png"/>
</section>
</main>
    </div>
  );
