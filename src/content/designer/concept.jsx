...
<h1 className="cd-page-title" data-i18n="dev_concept.title">Concept</h1>
...
<li>
<strong data-i18n="dev_concept.f1_title">Usage:</strong>
<span data-i18n-html="dev_concept.f1_desc">Map out the "big ideas" of your software to ensure all
                  required functionality is accounted for.</span>
</li>
</ul>
<img alt="Concept Blocks Flowchart" className="demo-img" src="/assets/images/concept-1.png"/>
<img alt="Concept Blocks Flowchart" className="demo-img" src="/assets/images/concept-2.png"/>
