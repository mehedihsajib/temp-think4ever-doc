...
<h1 className="cd-page-title" id="cdHomeTitle">Pages</h1>
<p style={{marginBottom: '26px'}} className="cd-overview-text">
...
<p style={{textAlign: 'justify'}} className="cd-overview-text"></p>
...
<span>The default view showing every document you have access
                  to.</span>
</li>
<li>
<strong>Tree View:</strong>
<span>A hierarchical folder-style structure to visualize how
                  pages and sub-pages are nested.</span>
</li>
<li>
<strong>Recent:</strong>
<span>Quickly jump back into the documents you've edited or
                  viewed most recently.</span>
</li>
<li>
<strong>Templates:</strong>
<span>Access pre-defined layouts to standardize documentation
                  (e.g., API docs, meeting minutes).</span>
</li>
</ul>
<img alt="Page Tabs" className="demo-img" src="/assets/images/page-tabs.png"/>
<h3 className="cd-sub-heading" id="key-features">Key Features:</h3>
...
<span>Click + New Workspace to create high-level containers
                  (e.g., "Engineering," "Marketing," or "Legal"). Each
                  workspace acts as a separate environment for related
                  documents.</span>
</li>
<li>
<strong>Pages:</strong>
<span>Within a workspace, click <strong>+ New Page</strong> to
                  start a new document. You can tag pages, attach files, and
                  bookmark important ones for instant access.</span>
</li>
</ul>
...
<p className="cd-overview-p">
              The editor allows for flexible content creation by treating
              every element (text, images, code snippets) as a "block."
            </p>
<ul className="cd-overview-ul">
<li>
<strong>Dynamic Layouts:</strong>
<span>Easily rearrange content by dragging and dropping
                  blocks.</span>
</li>
<li>
<strong>Rich Media Support:</strong>
<span>Embed images, videos, and technical diagrams directly into
                  your documentation.</span>
</li>
<li>
<strong>Collaborative Features:</strong>
<span>Use the Collaboration sub-menu to see who is currently
                  working on a document and track version history.</span>
</li>
</ul>
...
<p className="cd-overview-p">
              As your knowledge base grows, use the secondary navigation bar
              to find specific assets:
            </p>
<ul className="cd-overview-ul">
<li>
<strong>Tags:</strong>
<span>Filter pages based on custom keywords (e.g.,
                  #SprintPlanning).</span>
</li>
<li>
<strong>Files:</strong>
<span>A centralized view of all documents and images uploaded
                  across various pages.</span>
</li>
<li>
<strong>Bookmarks:</strong>
<span>Access your "pinned" pages that require frequent
                  reference.</span>
</li>
<li>
<strong>Search Bar:</strong>
<span>Use the global search in the top-right corner to find
                  specific text strings across all workspaces.</span>
</li>
</ul>
...
<br/>
                ...
                <ul className="cd-overview-ul">
<li>
<strong> If the workspace is empty:</strong> Click the
                    large purple <strong>+ Create First Page</strong> button
...
<br/>
                ...
                <br/>
<em>Note: If you haven't created a workspace yet, click
                  <strong>+ New Workspace</strong> first to create a container
                  for your new pages.</em>
</li>
<li>
<strong>Configure Page Details</strong>
<br/>
                Once the editor loads, you will typically define the
                following:
                <ul className="cd-overview-ul">
<li>
...
<li>
<strong>Bookmarks:</strong> If this is a page you will
                    refer to often, click the <strong>Bookmark</strong> icon
                    to pin it to your favorites list.
                  </li>
</ul>
<br/>
<em>Quick Tip: If you're unsure where to start, click the
                  Templates tab before creating a new page to see
                  pre-formatted layouts for meeting notes or project
                  requirements.</em>
</li>
</ol>
<img alt="Create Page" className="demo-img" src="/assets/images/page-create.jpg"/>
</div>
</section>
</main>
    </div>
