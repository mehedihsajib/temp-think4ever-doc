...
<h1 className="cd-page-title" data-i18n="tech_diag.title">
          Technical Diagrams
        </h1>
...
<p className="cd-overview-p" data-i18n-html="tech_diag.intro">
            The <strong>Technical Diagrams</strong> dashboard is a
            comprehensive visual management suite designed for architects,
            developers, and system planners. It serves as the central
            repository for all logic-based and structural visualizations of a
            project, ensuring that technical requirements and workflows are
            clearly documented.
          </p>
...
<li>
<strong data-i18n="tech_diag.b1_title">Diagram Type Title:</strong>
<span data-i18n-html="tech_diag.b1_desc">(e.g., Technology Stack, Infrastructure Diagram).</span>
</li>
<li>
<strong data-i18n="tech_diag.b2_title">Status Indicator:</strong>
<span data-i18n-html="tech_diag.b2_desc">An "ACTIVE" badge confirms the diagram is current and
                validated.</span>
</li>
<li>
<strong data-i18n="tech_diag.b3_title">Standardized Iconography:</strong>
<span data-i18n-html="tech_diag.b3_desc">Uses industry-standard visual markers for quick
                identification.</span>
</li>
</ul>
<img alt="Technical Diagrams Dashboard" className="demo-img" src="/assets/images/t-diagram.png"/>
</div>
<h3 className="h3 cd-page-title" data-i18n="avail_diag.title">
...
<span data-i18n-html="avail_diag.bad_res_desc">It automatically creates a "High-Level System
                  Architecture"
...
<span data-i18n-html="avail_diag.bad_best_desc">Rapidly documenting complex systems without drawing
                  every
...
<img alt="Toolbar Features" className="demo-img" src="/assets/images/diagram-5.png"/>
</div>
