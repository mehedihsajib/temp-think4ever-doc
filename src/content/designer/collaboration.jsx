...
<h1 className="cd-page-title">Collaboration</h1>


<div className="doc-section">
<p className="cd-overview-p">
            The Collaboration module is the communication engine of the
            platform. It centralizes all discussions, feedback loops, and
            shared permissions across your pages and workspaces, ensuring that
            team members can interact without leaving the project environment.
          </p>
<p className="cd-overview-p">
...
<span>Define how data points in this platform (e.g., Priority,
                Tracker) correspond to specific Jira fields.</span>
</li>
<li>
<strong>Sync Status:</strong>
<span>A real-time monitor showing the health of the connection and
                the timing of the last successful synchronization.</span>
</li>
<li>
...
<img alt="Collaboration Tabs" className="demo-img" src="/assets/images/collaburation-tabs.png"/>
...
<span>When you create a new Issue or Task here, it can
                automatically generate a corresponding ticket in Jira.</span>
</li>
<li>
...
<span>Updates made by external developers in Jira (such as changing
                ...
                your dashboard automatically.</span>
</li>
</ul>
...
<span>Your technical team can work in Jira while project managers
                and stakeholders monitor progress directly from the Knowledge
                &amp; Feedback modules.</span>
</li>
<li>
<strong>Consolidated Reporting:</strong>
<span>View Jira-based task completion rates within your internal
                Analytics and Summary views.</span>
</li>
<li>
<strong>Single Source of Truth:</strong>
<span>Avoid version conflicts by ensuring that comments and
                attachments added in one system are visible in the
                other.</span>
</li>
</ul>
<p className="cd-overview-p">
<em>Note: For the integration to function correctly, ensure your
              Jira API tokens are active and that the connected user has
              "Write" permissions in the target Jira project.</em>
</p>
</div>
</main>
    </div>
