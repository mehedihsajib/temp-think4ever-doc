...
<h1 className="cd-page-title">Requirements</h1>

<div className="yt-video" data-video-id="kqRaUoV8K-E"></div>
<h3 className="cd-sub-heading" id="navigation-structure">
          Structure &amp; Ideation
        </h3>
<img style={{maxWidth: '300px'}} alt="structure" className="demo-img" src="/assets/images/structure-and-ideation.png"/>
...
<img alt="structure" className="demo-img" src="/assets/images/structure-and-ideation-2.png"/>
<p className="cd-overview-p">
...
<p className="cd-overview-p"><strong>Requirements</strong></p>
<p className="cd-overview-p">
...
<li>
<strong>Usage:</strong>
<span>Define your MVP (Minimum Viable Product) features and user
                roles.</span>
</li>
</ul>
...
<img alt="structure" className="demo-img" src="/assets/images/structure-and-ideation-4.png"/>
</div>
</main>
    </div>
  );
