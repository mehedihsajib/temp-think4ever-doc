      ...
      <main>
        ...
        <div className="doc-section">
          <p className="cd-overview-p" data-i18n-html="tasks.intro">
            <strong>Tasks dashboard</strong> is the high-velocity command center
            where your project requirements are translated into actionable
            development steps. It provides a real-time audit trail of every
            operation performed by the AI agents&mdash;from deep-system analysis
            to front-end code implementation.
          </p>
          <h3 className="cd-sub-heading">Key Navigation &amp; Controls</h3>
          <ul>
            <li>
              <strong>Status Filters:</strong>
              <span data-i18n-html="tasks.knc_b1_desc">
                Easily toggle between Pending, In Progress, Completed, and
                Failed tasks to monitor project health.
              </span>
            </li>
            <li>
              ...
              <ul>
                <li>
                  ...
                  <span data-i18n-html="tasks.knc_b2_1_desc">
                    Sync the task queue with current agent activity.
                  </span>
                </li>
                <li>
                  <strong>Cancel/Delete All:</strong>
                  <span data-i18n-html="tasks.knc_b2_2_desc">
                    Manage your task history and halt active processes.
                  </span>
                </li>
                <li>
                  <strong>+ New Task:</strong>
                  <span data-i18n-html="tasks.knc_b2_3_desc">
                    Manually trigger a new objective, such as a code fix or a
                    new feature request.
                  </span>
                </li>
              </ul>
          ...
          <h3 className="cd-sub-heading">Anatomy of a Task Card</h3>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td data-i18n-html="tasks.aoc_r5_2">
                  ...
                  <strong>Code</strong> (blue) indicate the nature of the task's
                  result.
                </td>
              </tr>
            </tbody>
          </table>
          <h3 className="cd-sub-heading">Powerful Management Features</h3>
          <ul>
            <li>
              <strong>Gap Analysis &amp; Auditing:</strong>
              <span data-i18n-html="tasks.pmf_b1_desc">
                The system can automatically compare your
            ...
            <li>
              <strong>Subtask Branching:</strong>
              <span data-i18n-html="tasks.pmf_b2_desc">
                Use the <strong>+ New Subtask</strong> button to decompose large
                architectural goals into granular, manageable technical steps.
              </span>
            </li>
            <li>
              <strong>Version Tracking:</strong>
              <span data-i18n-html="tasks.pmf_b3_desc">
                Icons for <strong>Edit, Rerun</strong>, and
                <strong>Delete</strong> allow you to iterate on specific prompts
                until the output matches your exact vision.
              </span>
            </li>
            <li>
              <strong>File-Level Inspection:</strong>
              <span data-i18n-html="tasks.pmf_b4_desc">
                Tasks provide a transparent look at the specific files being
                read or modified, including file paths and sizes (e.g.,
                authController.js - 17290 bytes).
              </span>
            </li>
          </ul>
          <p className="cd-overview-p" data-i18n-html="tasks.tc_intro">
            <strong>Task Controls</strong> found in the upper right corner of
            the Project Tasks dashboard. They allow you to manage the entire AI
            agent queue with a single click.
          </p>
          <img alt="Task Controls" src="/assets/images/task-1.jpg" />
          <h3
            style={{ marginTop: "32px", fontSize: "1.05rem" }}
          ...
          <ul>
            <li>
              ...
              <span data-i18n-html="tasks.tc_refresh_2">
                Manually updates the task list.
              </span>
            </li>
            <li>
              <strong>When to use:</strong>
              <span data-i18n-html="tasks.tc_refresh_4">
                If you've just submitted a task or are waiting for an agent to
                finish a complex coding operation, hit Refresh to see the most
                current status (e.g., moving from "In Progress" to "Completed").
              </span>
            </li>
          </ul>
          <h3
          ...
          <ul>
            <li>
              <strong>Function:</strong>
              <span data-i18n-html="tasks.tc_cancel_2">
                Immediately halts all active and pending agent operations.
              </span>
            </li>
            <li>
              <strong>When to use:</strong>
              <span data-i18n-html="tasks.tc_cancel_4">
                Use this if you realize a prompt was incorrect or if the AI is
                heading in a technical direction you want to pivot away from. It
                prevents the system from wasting resources on tasks you no
                longer need.
              </span>
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Function:</strong>
              <span data-i18n-html="tasks.tc_delete_2">
                Clears your entire task history from the dashboard.
              </span>
            </li>
            <li>
              <strong>When to use:</strong>
              <span data-i18n-html="tasks.tc_delete_4">
                Best for "cleaning house" once a major milestone&mdash;like the
                TransparencySeal core architecture&mdash;is finished and
                verified. Note: This action is permanent and clears the audit
                trail.
              </span>
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Function:</strong>
              <span data-i18n-html="tasks.tc_new_2">
                Opens the New Task modal.
              </span>
            </li>
            <li>
              <strong>When to use:</strong>
              <span data-i18n-html="tasks.tc_new_4">
                This is your primary entry point for delegating work. Use it to
                trigger everything from a simple UI change to a massive database
                audit.
              </span>
            </li>
          </ul>
          <div>
            <h3 style={{ fontSize: "1.3rem" }} className="cd-sub-heading">
              Creating a New Task
            </h3>
            <p className="cd-overview-p" data-i18n-html="tasks.cnt_intro">
              The <strong>New Task</strong> modal is where you delegate specific
              objectives to specialized AI agents. To ensure the best results,
              you must provide a clear description, select the appropriate agent
              for the job, and associate the task with the correct project
              folder.
            </p>
            <img alt="New Task Modal" src="/assets/images/task-2.png" />
            <h3 className="cd-sub-heading">Components of New Task window:</h3>
            <h3
              style={{ marginTop: "24px", fontSize: "1.05rem" }}
              className="cd-sub-heading"
            >
              1. Task Description
            </h3>
            ...
            <ul>
              <li>
                ...
                <span data-i18n-html="tasks.cnt_1_b1_desc">
                  Instead of saying "Fix the login," try "Fix the authentication
                  logic in authController.js to prevent duplicate session
                  tokens."
                </span>
              </li>
              <li>
                <strong>Reference Assets:</strong>
                <span data-i18n-html="tasks.cnt_1_b2_desc">
                  Mention specific database tables, UI components, or
                  documentation files you want the agent to consider.
                </span>
              </li>
            </ul>
            <h3
            ...
            <ul>
              <li>
                ...
                <span data-i18n-html="tasks.cnt_fa_1_desc">
                  Discards the draft and returns you to the Project Tasks
                  dashboard.
                </span>
              </li>
              <li>
                <strong>Create Task:</strong>
                <span data-i18n-html="tasks.cnt_fa_2_desc">
                  Submits the prompt to the AI queue. You can track its progress
                  immediately on the main dashboard under the Pending or In
                  Progress tabs.
                </span>
              </li>
            </ul>
