  ...
  return (
    <div className="doc-page-content">
      <main>
        ...
        <section>
          <p>
            Tapping the Buy more credits button will display a list of available
            credit packages for purchase..
          </p>
          <div>
            <img
              alt="Buy More Credits"
              src="/assets/images/portal/01-buy-credits-1.png"
            />
            <img
              alt="Buy More Credits"
              src="/assets/images/portal/01-buy-credits-2.png"
            />
          </div>
          <h3>Metrics Bar</h3>
          <p>
