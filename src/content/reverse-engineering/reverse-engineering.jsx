      ...
      <main>
        ...
        <section>
          <p>
            ...
            systems or components, often to facilitate maintenance, improvement,
            or integration.
          </p>
          ...
          <div className="para-box">
            <p>
              <strong>Project Name Field</strong>
            </p>
          ...
          <div className="para-box">
            <p>
              <strong>Create Project Button</strong>
            </p>
            <p>Creates the new project and proceeds to the next setup step.</p>
          </div>

          <h3>Import an Existing Project</h3>
          <p>Imports an existing application or codebase into the platform.</p>
          <div className="para-box">
            <p>
          ...
          <div className="para-box">
            ...
            <p>Click Choose Source to continue to the import options screen.</p>
          </div>
          <div className="image-wrapper pb-0">
            <img
              alt="Create Project"
              src="/assets/images/re/02-create-project-2.png"
            />
          </div>
          ...
          <div className="para-box">
            <p>
              <strong>These options allow customers to: </strong>
            </p>
            <ul>
          ...
          <h3>Option 1 - Public GitHub URL</h3>
          <div className="para-box">
            <p>
            ...
            <br />
            <p>
              This option imports source code from a publicly accessible GitHub
              repository.
            </p>
            <div>
              <img
                alt="Create Project"
                src="/assets/images/re/03-import-source-2.png"
              />
            </div>
          </div>
          <div className="para-box">
          ...
          <div className="para-box">
            <p>
              <strong>Parameter Configurations &amp; Rules </strong>
            </p>
            <ul>
              <li>
              ...
              <li>
                Branch Specification: Define the explicit branch string you want
                to target (e.g., main or development). If you leave this field
                empty, or if the specified branch cannot be found in the
                repository index, the system automatically falls back to pulling
          ...
          <div className="para-box">
            <p>
              <strong>Executing the Repository Sync </strong>
            </p>
            <ol>
              <li>
              ...
              <li>
                ...
                selection menu if you need to choose an alternative upload path
                (like a local ZIP archive).
              </li>
              <li>
          ...
          <h3>Option 2 - ZIP File</h3>
          <div className="para-box">
            <p>
              <strong>Importing Source Code via ZIP Archive </strong>
            </p>
            <br />
            <p>
              When setting up a project workspace from an existing codebase, the
              platform provides a local file upload wizard as an alternative to
              external version control tracking.
            </p>
            <p>
              This option allows you to upload a compressed archive directly
              from your local computer. The system will automatically unpack and
              map the contained directories into your designated project folder.
            </p>
          </div>
          <div>
            <img alt="Upload Zip" src="/assets/images/re/07-upload-zip.png" />
          </div>
          <div className="para-box">
            <p>
          ...
          <div className="para-box">
            ...
            <ul>
              <li>
                ...
                <span>
                  Browse your local directories to select and transmit bundled
              ...
              <li>
                ...
                <span>
                  The backend system instantly runs an unzipping routine upon
              ...
              <li>
                ...
                <span>
                  Populates your empty developer environment with your
          ...
          <div className="para-box">
            <p>
              <strong>Step-by-Step Upload Procedure </strong>
            </p>
            <ol>
              <li>
                Click the <strong>Choose File</strong> target button within the
                configuration modal to trigger your operating system's native
                file explorer.
              </li>
              <li>
              ...
              <li>
                Keep your browser window open while the file is processed; once
                complete, your unpacked folder architecture will populate
                directly into the left side of your developer canvas.
              </li>
            </ol>
          </div>
          <h3>Option 3 &ndash; Git Provider (advanced)</h3>
          <p>
            The Git Provider (Advanced) option allows users to connect the
            project directly to a remote Version Control System (VCS) repository
            such as GitHub, GitLab, or Bitbucket using authenticated
            credentials.
          </p>
          <br />
          <p>
            This option is recommended for projects that are actively maintained
            in a source control repository and require secure access.
          </p>
          <div>
            <img
              alt="Git Provider"
              src="/assets/images/re/06-git-provider.png"
            />
          </div>
          <div className="para-box">
            <h3>What is a VCS?</h3>
          ...
          <div className="para-box">
            ...
            <p>
              Displays the target project workspace where the repository will be
              connected.
            </p>
          </div>
          <div className="para-box">
          ...
          <div className="para-box">
            <p>
              <strong>Supported Authentication Types </strong>
            </p>
            <p>May include:</p>
            <ul>
              <li>Access Token</li>
          ...
          <div className="para-box">
            <p>
              <strong>Save Integration Button </strong>
            </p>
            <p>
          ...
          <div className="para-box">
            <p>
              <strong>Notes and Recommendations </strong>
            </p>
            <p>
              Saves the repository configuration and establishes the connection.
            </p>
            <ul>
              ...
              <li>Verify that the access token has sufficient permissions.</li>
              <li>
        ...
        <section
          aria-labelledby="re-open-project-title"
          className="re-open-project-section"
        >
          <div className="re-open-project-shell">
            <div className="re-open-project-head">
              ...
              <button
                aria-label="Close"
                className="re-open-project-close"
                type="button"
              >
                &times;
              </button>
            ...
            <div className="re-open-project-cards">
              <a
                className="re-open-project-card re-open-project-card-design"
                href="/designer/introduction"
              >
              ...
              <a
                className="re-open-project-card re-open-project-card-dev"
                href="/developer/start-new-project#devDashboard"
              >
