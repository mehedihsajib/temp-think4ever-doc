...
(function () {
  ...
  const allResults = [
    ...
    },
    {
      ...
      excerpt:
        "Explore the product capabilities that power orchestration, collaboration, automation, and scalable agent workflows.",
    },
    {
      id: "r3",
      type: "docs",
    ...
    },
    {
      ...
      excerpt:
        "Set up a new initiative, define scope, and create the foundation for collaborative AI execution.",
    },
    {
      id: "r5",
      type: "guides",
      ...
      excerpt:
        "Configure project-level settings, collaboration preferences, and workspace controls for your team.",
    },
    {
      id: "r6",
      type: "blog",
    ...
    },
    {
      ...
      excerpt:
        "Understand how business processes are translated into orchestrated workflows and collaborative decision paths.",
    },
    {
      id: "r8",
      type: "changelog",
    ...
    },
    {
      ...
      excerpt:
        "Practical insights on team workflows, system orchestration, and what it takes to scale coordinated AI.",
    },
    {
      id: "r12",
      type: "docs",
  ...
  function bindEvents() {
    ...
    filterContainer.addEventListener("click", function (e) {
      ...
      filterContainer
        .querySelectorAll(".sr-filter-btn")
  ...
  function renderResults() {
    ...
    pageResults.forEach(function (result, idx) {
      const breadcrumbHtml = result.breadcrumb
        .map((bc, i) => {
  ...
  window.changeLanguage = function (lang) {
    ...
    document.querySelectorAll("[data-lang-btn]").forEach(function (btn) {
      btn.classList.toggle(
        "active",
        btn.getAttribute("data-lang-btn") === safeLang,
      );
    });
  ...
  const storedLang = (
    localStorage.getItem("mpay_locale") || "en"
  ).toLowerCase();
